Feature: Basic bean
  ...
  Scenario: Create, view and edit a basic bean
    ...
    Then I logout
    Given I am logged in as a user with the "edit any basic_content bean,view bean page" permission and don't need a password change
    ...
    And I should see "govCMS is the best!"
    Then I logout
    Given I am logged in as a user with the "edit any basic_content bean,view bean page,view bean revisions" permission and don't need a password change
